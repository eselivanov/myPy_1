...
warning: 
eval can be dangerous - it runs strings as code; 
...
def storeDbase(db, dbfilename=dbfilename):  # saving db to file
...
def loadDbase(dbfilename=dbfilename):   # reading db from file
